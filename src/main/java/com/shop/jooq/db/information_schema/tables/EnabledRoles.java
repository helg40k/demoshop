...
import com.shop.jooq.db.information_schema.tables.records.EnabledRolesRecord;
...
public class EnabledRoles extends TableImpl<EnabledRolesRecord> {
     ...
     */
    public final TableField<EnabledRolesRecord, String> ROLE_NAME = createField(DSL.name("role_name"), com.shop.jooq.db.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
