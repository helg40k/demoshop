...
import com.shop.jooq.db.pg_catalog.Indexes;
...
public class PgPublicationRel extends TableImpl<PgPublicationRelRecord> {
     ...
     */
    public final TableField<PgPublicationRelRecord, Object[]> PRATTRS = createField(DSL.name("prattrs"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"int2vector\"").getArrayDataType(), this, "");
