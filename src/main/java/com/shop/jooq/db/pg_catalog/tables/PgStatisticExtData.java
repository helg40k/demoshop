...
public class PgStatisticExtData extends TableImpl<PgStatisticExtDataRecord> {
     ...
     */
    public final TableField<PgStatisticExtDataRecord, PgStatisticRecord[]> STXDEXPR = createField(DSL.name("stxdexpr"), com.shop.jooq.db.pg_catalog.tables.PgStatistic.PG_STATISTIC.getDataType().getArrayDataType(), this, "");
